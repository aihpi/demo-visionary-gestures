...
import defaultComboImage from '../assets/images/rpsls.svg';
...
// Christmas-themed assets not available — falling back to defaults
const christmasLogo = defaultLogo;
const christmasComboImage = defaultComboImage;
const christmasRpsIcon = defaultRpsIcon;
const christmasRpslsIcon = defaultRpslsIcon;
const christmasRockIcon = defaultRockIcon;
const christmasPaperIcon = defaultPaperIcon;
const christmasScissorsIcon = defaultScissorsIcon;
const christmasLizardIcon = defaultLizardIcon;
const christmasSpockIcon = defaultSpockIcon;
